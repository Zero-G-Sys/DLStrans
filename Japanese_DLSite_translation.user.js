...
(function () {
  ...
  /*-----------------------------------------------------------------------------------*/
  // Create a mutation observers for elements that are created during page load
  ...
  // Elements that depend on another script and load even after that document ready state
